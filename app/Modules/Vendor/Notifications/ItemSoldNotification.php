...
/**
 * Vendor "item sold" alert (docs/firstmarket_Implementation_Plan.md Sprint 6
...
class ItemSoldNotification extends PreferenceAwareNotification implements ShouldQueue
{
    ...
    public function toMail(object $notifiable): MailMessage
    {
        return (new MailMessage)
            ...
            ->line('Sign in to your Vendor Center to confirm stock and pack the item within the preparation window. FirstMarket handles the delivery.')
            ->line('For customer privacy, buyer details are never shared with vendors.');
    }

    public function toSms(object $notifiable): string
    {
        return "FirstMarket: you sold \"{$this->productName}\" for {$this->amountNaira}. Pack it within the preparation window — see your Vendor Center.";
    }
