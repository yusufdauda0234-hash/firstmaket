...
/**
 * Launch FAQ content (docs/firstmarket_Implementation_Plan.md Sprint 7).
...
class FaqSeeder extends Seeder
{
    ...
    {
        $faqs = [
            ['Getting started', 'What is FirstMarket?', 'FirstMarket is a Nigerian marketplace where you can buy products outright (Pay At Once) or save toward them gradually at a locked price (Save Small Small). Products come from verified vendors and FirstMarket handles every delivery.'],
            ...
            ['Wallet & payments', 'Why do I need to verify my phone number?', 'A verified phone number secures your money movements. It is required before you can fund your wallet.'],
            ...
            ['Vendors', 'How do I sell on FirstMarket?', 'Register as a vendor with your CAC document. Once approved, list your products, set your own prices, and get paid to your verified bank account after each confirmed delivery.'],
