...
class FaqSeeder extends Seeder
{
    ...
    {
        $faqs = [
            ['Getting started', 'What is FirstMaket?', 'FirstMaket is a Nigerian marketplace where you can buy products outright (Pay At Once) or save toward them gradually at a locked price (Save Small Small). Products come from verified vendors and FirstMaket handles every delivery.'],
            ...
            ['Savings', 'Can I get my savings back as cash?', 'No — FirstMaket is not a bank and never pays out cash. Your savings always move toward a product: you can redirect them to a different product at any time while a plan is active.'],
            ...
            ['Wallet & payments', 'Is my payment information safe?', 'Yes. Payments are processed entirely by Paystack — FirstMaket never sees or stores your card details.'],
            ['Wallet & payments', 'Why do I need to verify my phone number?', 'A verified phone number adds a layer of account recovery and security, but it is optional — you can fund your wallet and use FirstMaket without it.'],
