...
/**
 * Where a vendor lands from the "set your password" email.
 *
 * Lives on the Vendor Center subdomain so the whole journey stays in the portal
 * they actually sign in to, rather than sending them to the customer site and
 * back. The token in the URL is the credential, so this page is guest-only.
 */
export default function VendorResetPassword() {
    ...
    const submit: FormEventHandler = (e) => {
        e.preventDefault();
        form.post(route('vendor.password.update'), {
        ...
        <div className="flex min-h-screen items-center justify-center bg-gray-900 p-4">
            ...
            <div className="w-full max-w-md rounded-2xl bg-white p-8 shadow-xl">
                ...
                <p className="mt-1.5 text-sm text-gray-500">
                    Choose a password for your FirstMaket Vendor Center account.
                </p>
                ...
                <form onSubmit={submit} className="mt-6 space-y-4">
                    <label className="block">
                        ...
                        <Input
                            ...
                            // Comes from the link; editable only so a vendor can
