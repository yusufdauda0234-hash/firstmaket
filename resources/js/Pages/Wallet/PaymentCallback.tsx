...
const config = {
    success: {
        ...
        body: 'Your wallet has been credited. You can start shopping or saving right away.',
    },
    pending: {
        icon: Clock,
    ...
    unknown: {
        ...
        body: 'If you just paid, give it a moment and check your wallet. Otherwise, start a new top-up.',
    },
} as const;
            ...
            <div className="mx-auto max-w-md px-4 py-12 text-center">
                ...
                <div className="mt-6 flex flex-col gap-2">
                    <Link href={route('wallet.index')}>
                        <Button className="w-full">Go to my wallet</Button>
                    </Link>
                    {(state === 'failed' || state === 'unknown') && (
                        <Link href={route('wallet.add-money')}>
